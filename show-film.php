		...
		//prevents the errors from appearing on the films, where no information can be provided from rotten tomatoes API
		error_reporting(0);
		?>
	...
	<div class= "row tomatoes"> 
		...
		$audienceScore = $films->ratings->audience_score;
			...
			// Uncomment the code to allow the user to gain access to all the data provided by Rottten Tomatoes 
			 /*echo '<pre>'; 
		 	print_r($films); 
			echo '</pre>';*/ 
